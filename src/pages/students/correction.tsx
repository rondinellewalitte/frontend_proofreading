      ...
      >
        ...
        <Box flex='1' borderRadius={8} bg="gray.800" p="8">
          ...
          <VStack spacing="8">
            ...
            <SimpleGrid minChildWidth="240px" spacing="8" w="100%">
              <Select variant="filled" bgColor="gray.900" _hover={{ bgColor: 'gray.900' }} borderColor="gray.900" placeholder='Selecione a aluno' focusBorderColor='pink.500' size='lg' variant='outline'>
                <option value='option2'>Option 2</option>
                <option value='option3'>Option 3</option>
              </Select>
            </SimpleGrid>
